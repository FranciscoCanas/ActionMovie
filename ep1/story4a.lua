...
Gamestate.story4a = Gamestate.new()
local state = Gamestate.story4a
local currentString = ""
...
local dialogue = {	
			"Axplosion Evoided!",
			"Victory Dance!",	
            "Once again the world is safe, thanks to Crispy P.I. and Detective McG--",
...
local shotFuncs = {
        function() 
			player1.animation=player1.standAnim
		...
		function()
			player2.animation=player2.standAnim
